      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
         ...
         Create your Bundl book in 5 minutes with our app.
          ...
          Select from your contacts and our mobile app gathers notes and pictures from your recipient&apos;s loved throughout the first week. During week two, your book is printed and shipped directly to you.
          </p>
        </div>
      </Container>
