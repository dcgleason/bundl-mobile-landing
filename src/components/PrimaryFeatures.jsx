...
const features = [
  ...
  },
  {
    ...
    description:
      "Unsure what to say your family, friends, and / or co-workers? We offer you suggestions on how to invite them to submit.",
  ...
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        ...
        <AppScreen.Subtitle >
          <span className='text-[#8b0000]'>Automate the collection <span className="text-white">of notes and pictures</span></span>
        </AppScreen.Subtitle>
          ...
          <div className="space-y-6">
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                rows="5"
                defaultValue="Hey! So, Eliza is turning 30 and I am making her a special gift called a 'Bundl book.' It's a book full of love, filled with notes and pictures from all of her loved ones. Please join in and add your own message or photo for Eliza! Think she is going to love it."
              ></textarea>
            </div>
          </div>
          <div className="mt-6 rounded-lg bg-[#727B84] px-3 py-2 text-center text-sm font-semibold text-white">
            Send invite
          </div>
        </div>
      </MotionAppScreenBody>
        ...
        <div className="divide-y divide-gray-100">
          {prompts.map((prompt, index) => (
            <div key={index} className="flex items-center gap-4 px-4 py-3">
              <div className="flex-auto text-sm text-gray-900">{prompt}</div>
            </div>
          ))}
        </div>
      </MotionAppScreenBody>
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
         ...
         Create your Bundl book in 5 minutes with our app.
          ...
          Select from your contacts and our mobile app automatically gathers notes and pictures from your recipient&apos;s loved ones during week one. During week two, your book is printed and shipped directly to you.
          </p>
        </div>
      </Container>
