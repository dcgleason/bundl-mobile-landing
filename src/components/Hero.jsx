      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            Give your friend or family member a <em>&apos;Bundl&apos;</em> (a.k.a send them daily emails, each filled with special, prompt-driven written notes, audio-clips, and memorable pictures collected from their friends and family with our mobile app)! Great for birthdays, babyshowers, retirements, etc.
            </p>
