        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-gray-600">
             Bundl Book: A way to elicit happy tears with with 5 minutes of work .... a.k.a. a surprise, physical gift book your friend or family member filled with supportive & loving notes + pictures from <em>your loved one&apos;s</em> family and friends. Great for birthdays, babyshowers, retirements, etc.
            </p>
