      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            Your most thoughtful gift...ever. 

           </h1>
            <p className="mt-6 text-lg text-gray-600">
             Bundl Book: A surprise gift book filled with supportive and celebratory notes and pictures from your recipient&apos;s family and friends. Great for milestone birthdays, babyshowers, retirement parties, etc.
            </p>
