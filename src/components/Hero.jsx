      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
           ...
           Make your loved one cry try tears of joy.
           </h1>
            <p className="mt-6 text-lg text-gray-600">
            Blow your loved one away by gifting them heartwarming messages from their family and friends...all at once. <br></br> <br></br>With Bundl&apos;s mobile app, easily gift meaningful, prompt-driven written notes, audio-clips, and memorable pictures from your loved one&apos;s loved ones in the from of a book.  Great for to milestone birthdays, baby-showers, retirement parties, etc.
            </p>
          ...
          <div className="relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6">
            ...
            <div className="mx-4 px-9 [mask-image:linear-gradient(to_bottom,white_95%,transparent)] sm:mx-0 lg:absolute lg:-inset-x-10 lg:bottom-auto lg:-top-20 lg:h-auto lg:px-0 xl:bottom-0">
              {/* <DynamicPDFViewer fileUrl="/mom-bundl-interior.pdf" /> */}
            </div>
          </div>
