        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
           ...
           Make your loved one cry tears of joy.
            ...
            Blow your loved one away by gifting them heartwarming messages from their family and friends...all at once. <br></br> <br></br>With Bundl&apos;s mobile app, easily gift meaningful, prompt-driven written notes, audio-clips, and memorable pictures in the from of a book. <br></br><br></br> A great gift for milestone birthdays, baby-showers, retirement parties, etc.
            </p>
          ...
          <div className="relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6 h-[800px] -translate-y-96"> {/* Added -translate-y-24 */}
            <BackgroundIllustration className="absolute left-1/2 top-4 h-[1026px] w-[1026px] -translate-x-1/3 stroke-gray-300/70 [mask-image:linear-gradient(to_bottom,white_20%,transparent_75%)] sm:top-16 sm:-translate-x-1/2 lg:-top-16 lg:ml-12 xl:-top-14 xl:ml-0" />
            <div className="mx-4 px-9 h-full z-50 [mask-image:linear-gradient(to_bottom,white_95%,transparent)] sm:mx-0 lg:absolute lg:-inset-x-10 lg:bottom-auto lg:-top-20 lg:h-auto lg:px-0 xl:bottom-0"> {/* Kept h-full */}
              <DynamicPDFViewer fileUrl="/mom-bundl-interior-cropped.pdf" />
            </div>
          </div>
