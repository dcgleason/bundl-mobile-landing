...
const plans = [
  {
    ...
    features: [
      ...
      'Digital preview of Bundl Book sent to you',
      'Simple submissions collection',
      'Guided prompts for heartfelt messages',
      'Paperback quality',
      'Up to 20 pages',
    ],
  ...
  },
  {
    ...
    features: [
      'All features of The Starter',
      'Choose the color of your cover design',
      'Priority support',
  ...
  },
  {
    ...
    features: [
      'All features of The Romantic',
      'Personalized proposal planning consultation',
      'Premium gift wrapping',
      'Exclusive access to proposal resources',
      'Unlimited investment',
      'Linen wrap hardback quality',
      'Unlimited pages',
