 ...
 function Price() {
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl sm:text-center">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Flexible Payment Options Tailored to Your Needs.</h2>
      <p class="mt-6 text-lg leading-8 text-gray-600">Plans start at just $10/month.</p>
    </div>
    <div class="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
      <div class="p-8 sm:p-10 lg:flex-auto">
        <h3 class="text-2xl font-bold tracking-tight text-gray-900">Single Keepsake Book</h3>
        <p class="mt-6 text-base leading-7 text-gray-600">Automated, elegantly designed, and purpose-built to enhance team cohesion.</p>
        <div class="mt-10 flex items-center gap-x-4">
          <h4 class="flex-none text-sm font-semibold leading-6 text-black">Included Features</h4>
        ...
        <ul role="list" class="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 text-gray-600 sm:grid-cols-2 sm:gap-6">
          <li class="flex gap-x-3">
            ...
            Automated collection of contributions
          </li>
          <li class="flex gap-x-3">
            <svg class="h-6 w-5 flex-none text-black" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd" />
            </svg>
            Custom hardcover book featuring your company logo
          </li>
          <li class="flex gap-x-3">
            <svg class="h-6 w-5 flex-none text-black" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd" />
          ...
          <li class="flex gap-x-3">
            ...
            Your personalized messages included
          </li>
        </ul>
      </div>
          ...
          <div class="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
            <div class="mx-auto max-w-xs px-8">
              <p class="mt-6 flex items-baseline justify-center gap-x-2">
                <span class="text-5xl font-bold tracking-tight text-gray-900 ">$79.99</span>
              ...
              <p class="mt-6 text-xs leading-5 text-gray-600">Pay only for the gifts you actually send.</p>
            </div>
          </div>
        </div>
    </div>
...
const tiers = [
  ...
  //   features: [
  //     'Digital, styled PDF of a submissions',
