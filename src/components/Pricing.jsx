  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div class="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
      <div class="p-8 sm:p-10 lg:flex-auto">
        ...
        <p class="mt-6 text-base leading-7 text-gray-600">Linen hardback with unlimited pages. Ability for each contributor to record an audio clip, which appears as a QR code next to their note, included.</p>
