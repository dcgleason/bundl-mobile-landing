        ...
        <Container className="-mb-20 mt-24 sm:mt-32 md:mt-56">
          ...
          Increase Productivity. Lower Spend. Build Culture.
            ...
            <p className="mt-6 text-xl text-neutral-600 ">
              ...
              to <span className='underline'>recognize</span> and <span className='underline'>reward</span> employees and drives business success as a result <a className="italic" href="/GallupRecognitionPaper.pdf" target="_blank" rel="noopener noreferrer">[source]</a>. <br></br><br></br>Allow your team members to easily create digital or physical books that contain praise and positive feedback from co-workers. This feedback can be in the form of text, audio, or pictures, offering a personalized way to appreciate individual employees.
            </p>
            </FadeIn>
